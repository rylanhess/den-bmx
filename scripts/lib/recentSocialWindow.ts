/**
 * Calendar-day window for social ingest (America/Denver).
...
export function recentPostCutoff(referenceDate = new Date()): Date {
  ...
  // Parse cutoff midnight in Denver via offset trick
...
export const RECENT_POST_DAYS = RECENT_CALENDAR_DAYS_PRIOR;
