...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md border-2 border-[#00ff0c] rounded-lg p-8 bg-black text-center">
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md border-2 border-[#00ff0c] rounded-lg p-8 bg-black">
        ...
        <p className="text-gray-400 text-center text-sm mb-8">Create an account to access the message board</p>
