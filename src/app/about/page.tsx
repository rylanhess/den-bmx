  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-12 md:py-16 max-w-6xl relative z-10">
        ...
        {/* Contact CTA */}
        <div className="bg-gray-900/90 border-4 border-[#00ff0c] p-8 text-center backdrop-blur-sm mb-12">
          ...
          <Link
            href="/contact"
            className="inline-block bg-black hover:bg-white text-[#00ff0c] hover:text-black font-black py-4 px-12 border-4 border-black transition-colors transform hover:scale-110 text-2xl mb-8"
          >
        ...
        <div className="bg-black border-4 border-[#00ff0c] p-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <a
              ...
              className="bg-gray-900/90 border-4 border-[#00ff0c] p-4 hover:bg-[#00ff0c] hover:text-black transition-all backdrop-blur-sm flex items-center justify-center gap-3"
            >
