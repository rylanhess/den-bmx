...
const downloadFiles = [
  ...
  },
  {
    ...
    description: 'Complete PowerPoint template pack with all designs and editable templates',
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-12 md:py-16 max-w-6xl relative z-10">
                ...
                <div className="bg-gray-900/90 border-4 border-[#00ff0c] p-6 flex items-center justify-center min-h-[200px] backdrop-blur-sm">
                  {item.type === 'image' ? (
                    ...
                    <div className="text-center">
                      <DocumentIcon className="w-24 h-24 mx-auto mb-4 text-[#00ff0c]" />
                      <p className="text-white font-black text-xl">POWERPOINT TEMPLATE</p>
                      <p className="text-white font-bold text-sm mt-2">{item.format} Format</p>
                    </div>
                  )}
                </div>
        ...
        {/* License Info */}
        <div className="bg-black border-4 border-[#00ff0c] p-6 md:p-8 text-center">
          <h2 className="text-4xl font-black text-[#00ff0c] mb-4">
            COMPLETELY FREE
          </h2>
